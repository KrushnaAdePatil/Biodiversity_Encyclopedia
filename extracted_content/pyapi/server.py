...
Serves every API used by the vanilla HTML/CSS/JS frontend:
  /ping, /stats, /categories, /subcategories, /facets, /species,
  /species/{slug}, /suggest, /day, /trending, /facts, /quiz, /atlas,
  /sightings (GET/POST), /contribute (POST),
  /gallery (Wikimedia photo feed), /image (same-origin image proxy).
"""
